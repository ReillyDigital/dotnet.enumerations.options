...
public static partial class OptionsFunctions
{
	...
	public static IOptionEnumerableError<TValue> OptionEnumerableError<TValue>() => IOptionEnumerable<TValue>.Error();

	/// <inheritdoc cref="IOptionEnumerable{}.Error(Exception)" />
	public static IOptionEnumerableError<TValue> OptionEnumerableError<TValue>(Exception value) =>
	...
	public static IOptionEnumerableError<TValue, TError> OptionEnumerableError<TValue, TError>(TError value) =>
