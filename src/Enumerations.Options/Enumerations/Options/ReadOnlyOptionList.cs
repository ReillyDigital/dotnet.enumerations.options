...
public sealed class ReadOnlyOptionList<TValue>
	: IOptionEnumerable<TValue>, IReadOnlyList<IOption<TValue>>
{
	...
	public ReadOnlyOptionList(IEnumerable<IOption<TValue>> values) => List = [..values];

	/// <summary>
	/// Constructor for this collection, having its items set to the provided values.
	/// </summary>
	/// <param name="values">The items of the new collection.</param>
	public ReadOnlyOptionList(List<IOption<TValue>> values) => List = [..values];
...
public sealed class ReadOnlyOptionList<TValue, TError>
	: IOptionEnumerable<TValue, TError>, IReadOnlyList<IOption<TValue, TError>>
{
	...
	/// </summary>
	/// <param name="values">The items of the new collection.</param>
	public ReadOnlyOptionList(IEnumerable<IOption<TValue, TError>> values) => List = [..values];

	/// <summary>
	/// Constructor for this collection, having its items set to the provided values.
	/// </summary>
	/// <param name="values">The items of the new collection.</param>
	public ReadOnlyOptionList(List<IOption<TValue, TError>> values) => List = [..values];
