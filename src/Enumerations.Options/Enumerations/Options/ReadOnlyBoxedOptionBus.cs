...
/// type is added to the bus. Errors are of type <see cref="string" />.
/// </summary>
/// <typeparam name="TValue">The type of the value of the options.</typeparam>
public sealed class ReadOnlyBoxedOptionBus<TValue>(BoxedOptionBus<TValue> optionBus) : IVoid
{
	/// <summary>
...
public sealed class ReadOnlyBoxedOptionBus<TValue, TError>(
	BoxedOptionBus<TValue, TError> optionBus
) : IVoid<TError>
{
	/// <summary>
	/// An event triggered when the bus is ended.
